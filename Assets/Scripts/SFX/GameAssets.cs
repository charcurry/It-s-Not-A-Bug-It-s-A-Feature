...
public class GameAssets : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Debug.Log("Sound settings initialized");
    ...
    public void InitializeSoundSettings()
    {
        soundSettingsDictionary.Add(SoundManager.Sound.Moving_Platform, new SoundSettings 
            { maxDistance = 25f, dopplerLevel = 0, audioRolloffMode = AudioRolloffMode.Logarithmic, isLooped = true, isMoving = false, destroyAfterFinished = false, volume = uxVariables.flSfxVolume });
        soundSettingsDictionary.Add(SoundManager.Sound.Player_Jump, new SoundSettings 
            { maxDistance = 100f, dopplerLevel = 0, audioRolloffMode = AudioRolloffMode.Logarithmic, isLooped = false, isMoving = false, destroyAfterFinished = true, volume = uxVariables.flSfxVolume });
        ...
        soundSettingsDictionary.Add(SoundManager.Sound.Air_Vent, new SoundSettings 
            { maxDistance = 17.5f, dopplerLevel = 0, audioRolloffMode = AudioRolloffMode.Linear, isLooped = true, isMoving = false, destroyAfterFinished = false, volume = uxVariables.flSfxVolume });
        ...
        soundSettingsDictionary.Add(SoundManager.Sound.Door_Open_2, new SoundSettings
            { maxDistance = 200f, dopplerLevel = 0, audioRolloffMode = AudioRolloffMode.Logarithmic, isLooped = false, isMoving = false, destroyAfterFinished = true, volume = uxVariables.flSfxVolume });
